...
ApplicationWindow {
    ...
    Connections {
        ...
        function onColorChanged() {
            statusText.text = "Цвет обновлён."
        }
        function onCopied(text) {
            statusText.text = "Скопировано: " + text
        }
    ...
    Window {
        ...
        function updateHud(mx, my) {
            var hx = mx + 28
            if (hx + hud.width > pickerArea.width - 8) {
                hx = mx - hud.width - 28
            }

            var hy = my + 28
            if (hy + hud.height > pickerArea.height - 8) {
                hy = my - hud.height - 28
            }
        ...
        MouseArea {
            ...
            onPositionChanged: {
                ...
                if (info.magnifier) {
                    magnifierImage.source = info.magnifier
                }
    ...
    Window {
        ...
        ColumnLayout {
            ...
            DarkCheckBox {
                text: "Автоматически копировать при клике"
                checked: backend.autoCopy
                onToggled: backend.autoCopy = checked
            }
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    radius: 8
                    color: "#171D28"
                    border.color: hotkeyBox.ok ? "#3C4454" : "#FF6B6B"
            ...
            DarkCheckBox {
                text: "Запускаться вместе с системой"
            ...
            Button {
                ...
                background: Rectangle {
                    color: parent.hovered ? "#3D2E1A" : "#2A1F10"
                    radius: 10
                    border.color: "#FFB74D"
                }
            }
            ...
            Button {
                ...
                background: Rectangle {
                    color: parent.hovered ? "#232D3F" : "#171D28"
                    radius: 10
                    border.color: "#3C4454"
                }
            }
    ...
    // ------------------------------------------------------------------------
    // Главный интерфейс (Main UI)
    // ------------------------------------------------------------------------

    // Тост "Настройки сохранены"
    Text {
        id: savedToast
        ...
        ColumnLayout {
            ...
            Row {
                ...
                Button {
                    ...
                    background: Rectangle {
                        color: settingsButton.hovered ? "#232D3F" : "#171D28"
                        radius: 10
                        border.color: "#3C4454"
                    }
                }
            ...
            GridLayout {
                ...
                Text { text: "HEX"; color: "#AAB2C0"; font.pixelSize: 11; Layout.preferredWidth: 70 }
                Text { text: backend.hex; color: "#F3F6FF"; font.pixelSize: 11; font.bold: true; Layout.fillWidth: true }
                CopyButton { copyText: backend.hex }

                Text { text: "RGB"; color: "#AAB2C0"; font.pixelSize: 11; Layout.preferredWidth: 70 }
                Text { text: backend.rgb; color: "#F3F6FF"; font.pixelSize: 11; font.bold: true; Layout.fillWidth: true }
                CopyButton { copyText: backend.rgb }

                Text { text: "HSL"; color: "#AAB2C0"; font.pixelSize: 11; Layout.preferredWidth: 70 }
                Text { text: backend.hsl; color: "#F3F6FF"; font.pixelSize: 11; font.bold: true; Layout.fillWidth: true }
                CopyButton { copyText: backend.hsl }

                Text { text: "Контраст"; color: "#AAB2C0"; font.pixelSize: 11; Layout.preferredWidth: 70 }
                Text {
                ...
                Repeater {
                    ...
                    Rectangle {
                        ...
                        MouseArea {
                            ...
                            onClicked: backend.copyText(modelData.hex)
                        }
                    }
                }
            }
                        ...
                        MouseArea {
                            ...
                            onClicked: (mouse) => {
                                if (mouse.button === Qt.RightButton) {
                                    backend.removeFromHistory(index)
                                } else {
                                    backend.copyText(modelData.hex)
                                }
                            }
                        }
                    }
